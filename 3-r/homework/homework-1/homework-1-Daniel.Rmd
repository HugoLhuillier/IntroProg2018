...
```{r, echo = TRUE}
setwd("C:/Users/Gyetvai Dani/Desktop/Programming/IntroProg2018/data")
...
```{r, echo = TRUE}
help(seq)
seq(from = 2, to = 60, by = 2)
y <- c(seq(from = 2, to = 60, by = 2))
str(y)
help(data.frame)
x <- data.frame(d[y,1:5])
str(x)
z <- (1/2)*x
str(z)
```
...
apply(d[,c(seq(from = 2, to  = 40, by = 2))], 2, max)
apply(d[1:5,], 1, mean)
```
