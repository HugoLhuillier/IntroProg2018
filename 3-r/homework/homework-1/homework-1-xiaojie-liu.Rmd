...
d=read.csv(file="C:/Users/JIEJIE/Desktop/data/inflammation-02.csv")
```
...
1. Create a new data frame in which you halve the first five daysâ€? values in __only__ those patients (remember how to subset a data frame? that's no more complicated than that!)
